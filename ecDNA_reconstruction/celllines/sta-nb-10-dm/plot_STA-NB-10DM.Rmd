---
title: "STA-NB-10DM reconstruction"
...
output:
  ...
  pdf_document:
    toc: yes
params:
  root: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/STA-NB-10-DM_26042021/hg38
  fname: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/STA-NB-10-DM_26042021/hg38/decoil_v108_tuned/reconstruct.ecDNA.pdf
  nodefile: decoil_v108_tuned/reconstruct.ecDNA.bed
  edgesfile: decoil_v108_tuned/reconstruct.links.ecDNA.txt
  sample: STA-NB-10-DM_26042021
  bw: coverage_hg38.bw
  maxcov: 600
  refgenome: /Users/madag/Projects/PhD/reference/GRCh38.primary_assembly.genome.fa
  gencode: /Users/madag/Projects/PhD/github/reconstruct/simulation/data/annotation/gencode_hg38
  anno: /Users/madag/Projects/PhD/annotation/gencode.v42.protein_coding_genes.txt
  gtf: /Users/madag/Projects/PhD/annotation/gencode.v42.primary_assembly.basic.annotation.gtf
---
...
gencode = track.gencode(stack.gap = 1e+06, cex.label = 0.3, height = 100,
                        name = 'GENCODE', cached = T, 
                        cached.dir = Sys.getenv("GENCODE_DIR"),
                        labels.suppress.gr=T, gene.collapse = T)
                        # genes=c("MYCN","MDM2","DDX1","TRIB3","LPIN1","NBAS","GACAT3","CDK4","CYRIA"))
                        # genes=read.csv2(annofile,header=F,"\t")$V1)
```
