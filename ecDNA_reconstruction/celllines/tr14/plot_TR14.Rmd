...
output:
  ...
  html_document:
    toc: yes
params:
  root: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/TR14_WGS_20022022/hg38
  fname: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/TR14_WGS_20022022/hg38/decoil_v108_tuned/reconstruct.ecDNA.pdf
  nodefile: decoil_v108_tuned/reconstruct.ecDNA.bed
  edgesfile: decoil_v108_tuned/reconstruct.links.ecDNA.txt
  sample: TR14_WGS_20022022
  bw: coverage_hg38.bw
  maxcov: 600
...
gencode = track.gencode(stack.gap = 1e+06, cex.label = 0.3, height = 100,
                        ...
                        genes=c("MYCN","MDM2","DDX1","TRIB3","LPIN1","NBAS","GACAT3","CDK4","SMC6","GEN1","SAMD11"))
