...
output:
  ...
  pdf_document:
    toc: yes
params:
  root: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/CHP126_01012021/hg19
  fname: /Volumes/henssen_lab/data/Nanopore/Celllines/Process/CHP126_01012021/hg19/decoil_v108_01072023_tuned/reconstruct.ecDNA.pdf
  nodefile: decoil_v108_01072023_tuned/reconstruct.ecDNA.filtered.bed
  edgesfile: decoil_v108_01072023_tuned/reconstruct.links.ecDNA.filtered.txt
  sample: CHP126_01012021
  bw: coverage.bw
  maxcov: 2500
...
gencode = track.gencode(stack.gap = 2e5, cex.label = 0.5, height = 60,
                        ...
                        labels.suppress.gr=T, gene.collapse = T, genes=c("MYCN","DDX1","TRIB3","LPIN1","NBAS","GACAT3","SMC6","GEN1","FAM49A","CDK4","SAMD11","MDM2"))
```
